...
import com.practicum.playlistmaker.old.creator.domain.api.SearchHistoryRepository
import com.practicum.playlistmaker.old.creator.domain.models.Track

class SearchHistoryRepositoryImpl(
    private val sharedPreferences: SharedPreferences,
    private val gson: Gson
) :
    com.practicum.playlistmaker.old.creator.domain.api.SearchHistoryRepository {
    override fun getHistory(): List<com.practicum.playlistmaker.old.creator.domain.models.Track> {
