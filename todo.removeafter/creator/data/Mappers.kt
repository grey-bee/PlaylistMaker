...
import com.practicum.playlistmaker.old.creator.data.dto.TrackDto
...
fun TrackDto.toTrack(): com.practicum.playlistmaker.old.creator.domain.models.Track =
    _root_ide_package_.com.practicum.playlistmaker.old.creator.domain.models.Track(
        this.trackId,
        this.trackName,
        this.artistName,
